...
function outPutInputs() {
  ...
  const cntdTime = cntdDate.setHours(
    document.getElementById("time").value.split(":")[0] || 0,
    document.getElementById("time").value.split(":")[1] || 0
  );
...
document
  .getElementById("create-countdown")
  .addEventListener("click", outPutInputs);
